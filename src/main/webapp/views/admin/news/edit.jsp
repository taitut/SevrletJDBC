            ...
            <form id="formSubmit">
              ...
              <div class="form-group">
                <div class="col-sm-12">
                  ...
                  <c:if test="${empty model.id}">
                    <input type="button" class="btn btn-white btn-warning btn-bold" value="Add News" id="btnAddOrUpdateNew"/>
                  </c:if>
                  &nbsp <input type="button" class="btn btn-white btn-warning btn-bold" value="Cancel" id="btnCancel"/>
