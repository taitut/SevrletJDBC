			...
			<ul class="nav ace-nav">
				<li class="light-blue"><a data-toggle="dropdown" href="#"
					...
					<ul
						...
						<li><a href="<c:url value='/login?action=logout'/>"> <i class="ace-icon fa fa-power-off"></i>
								Logout
						</a></li>
					</ul>
				</li>
				<li class="purple">
					<a href="<c:url value='/login?action=logout'/>" > <i class="ace-icon fa fa-power-off"></i></i>
				</a>
