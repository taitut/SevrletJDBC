            ...
            <ul class="nav ace-nav">
                ...
                <li class="green"><a data-toggle="dropdown"
                    ...
                    <ul
                            class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        <li class="dropdown-header"><i
                                class="ace-icon fa fa-envelope-o"></i> 5 Messages
                        </li>
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="hidden-480"><i
                                                            class="ace-icon fa fa-caret-right blue"></i>status
                                                    </th>
                                                </tr>
                                                </thead>
                                                    ...
                                                    <div class="comments">
                                                        <div class="itemdiv commentdiv">
                                                            ...
                                                            <div class="body">
                                                                ...
                                                                <div class="text">
                                                                    <i class="ace-icon fa fa-quote-left"></i> Lorem
                                                                    ipsum
                                                        ...
                                                        <div class="itemdiv commentdiv">
                                                            ...
                                                            <div class="tools">
                                                                <div class="action-buttons bigger-125">
                                                                    <a href="#"> <i
                                                                            class="ace-icon fa fa-pencil blue"></i>
                                                                    </a> <a href="#"> <i
...
<script type="text/javascript">
    if ('ontouchstart' in document.documentElement) document.write("<script src='<c:url value='/template/admin/jquery.mobile.custom.min.js'/>'>" + "<" + "/script>");
</script>

<script src="<c:url value='/template/admin/js/bootstrap.min.js'/>"></script>

<script
        src="<c:url value='/template/admin/js/jquery-ui.custom.min.js' />s"></script>
<script
